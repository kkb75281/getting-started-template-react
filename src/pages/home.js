	...
	return (
		<div>
			...
			<p>
				...
				<br />No CSS is used in this template. So don't let the design fool you.
				<br />This template packs full solid authentication features you can use in your HTML application.
			</p>
